  ...
  return (
    <div className="phone" aria-hidden>
      <div className="phone-screen theme-cream sf">
        ...
        <div style={{ margin: "0 14px", height: 54, borderRadius: 14, background: "var(--hero-grad)", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ margin: "10px 14px 0", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 9 }}>
